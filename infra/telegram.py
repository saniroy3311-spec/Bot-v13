...
class Telegram:
    ...
    async def notify_entry(self, *args, **kwargs):
        ...
        atr = kwargs.get("atr", trade.get("atr", getattr(trade, "atr", 65.0)))
        rr = kwargs.get("rr", kwargs.get("r_multiple", trade.get("rr", getattr(trade, "rr", 3.65))))
    ...
    async def notify_exit(self, *args, **kwargs):
        ...
        gross = kwargs.get("gross", kwargs.get("gross_pnl", trade.get("gross_pnl", getattr(trade, "gross_pnl", args[5] if len(args) > 5 else 0.0))))
        lots = kwargs.get("lots", trade.get("lots", getattr(trade, "lots", 100)))
